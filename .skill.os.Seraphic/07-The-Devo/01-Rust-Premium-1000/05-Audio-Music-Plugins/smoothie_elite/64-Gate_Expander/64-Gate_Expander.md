...
**Research Commands:**
```bash
websearch "Rust audio gate-&-expander 2025"
websearch "audio gate-&-expander algorithm"
```
...
*Skill ID: 64 | Category: Gate & Expander | Complexity: Foundation-Advanced*