...
**Research Commands:**
```bash
websearch "Rust audio sdf-display 2025"
websearch "audio sdf-display algorithm"
```
...
*Skill ID: 86 | Category: SDF Display | Complexity: Foundation-Advanced*