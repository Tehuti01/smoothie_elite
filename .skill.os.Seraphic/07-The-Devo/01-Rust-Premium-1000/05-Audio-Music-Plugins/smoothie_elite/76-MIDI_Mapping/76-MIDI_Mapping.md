...
**Research Commands:**
```bash
websearch "Rust audio midi-mapping 2025"
websearch "audio midi-mapping algorithm"
```
...
*Skill ID: 76 | Category: MIDI Mapping | Complexity: Foundation-Advanced*