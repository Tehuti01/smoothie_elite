...
**Research Commands:**
```bash
websearch "Rust audio effects-chain 2025"
websearch "audio effects-chain algorithm"
```
...
*Skill ID: 58 | Category: Effects Chain | Complexity: Foundation-Advanced*