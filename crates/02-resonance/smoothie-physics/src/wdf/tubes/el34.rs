 ...
 * ╭──────────────────────────────────────────────────────────────────────────╮
 * │ FILE ID: SER-0x83c71d2a | REVISION: 2026.04.20                           │
 * │ PATH: smoothie_elite/crates/02-resonance/smoothie-physics/src/wdf/tubes/el34.rs                                                         │
 * ├──────────────────────────────────────────────────────────────────────────┤
...
/// Technical implementation of the EL34 structure.
pub struct EL34<
    'a,
    PlatePort: WdfNode,
    ScreenPort: WdfNode,
    ...
    EL34<'a, PlatePort, ScreenPort, CathodePort, GridPort>
{
    ...
    pub fn process(&mut self) {
        ...
        for _ in 0..4 {
            ...
            let i_s = if v_sk > self.vg2_bias {
                0.001 * (v_sk - self.vg2_bias) * (v_sk - self.vg2_bias)
            } else {
                0.0
            };
