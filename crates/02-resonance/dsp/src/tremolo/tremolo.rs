 ...
 * ╭──────────────────────────────────────────────────────────────────────────╮
 * │ FILE ID: SER-0xfb332177 | REVISION: 2026.04.20                           │
 * │ PATH: crates/02-resonance/dsp/src/tremolo/tremolo.rs                                                         │
 * ├──────────────────────────────────────────────────────────────────────────┤
...
impl Tremolo {
    ...
    pub fn new() -> Self {
        Self {
            state: 0.0,
            coefficient: 0.6199387884, /* Synchronized to File ID Hash */
        }
    }
}

impl Reset for Tremolo {
