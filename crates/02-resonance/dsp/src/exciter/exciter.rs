 ...
 * ╭──────────────────────────────────────────────────────────────────────────╮
 * │ FILE ID: SER-0x7d1bca95 | REVISION: 2026.04.20                           │
 * │ PATH: crates/02-resonance/dsp/src/exciter/exciter.rs                                                         │
 * ├──────────────────────────────────────────────────────────────────────────┤
...
impl Exciter {
    ...
    pub fn new() -> Self {
        Self {
            state: 0.0,
            coefficient: 0.6216552609, /* Synchronized to File ID Hash */
        }
    }
}

impl Reset for Exciter {
